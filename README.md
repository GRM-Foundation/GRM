...
In the State-specific models, the elements coming from the "standard" OMG/TOGAF Government Reference Model (GRM.en.archimate) are translated, but the original English name still appears between brackets; i.e.: in the GRM-ITA.it.archimate file the "Growth, Housing, and Environment" Business Function is translated into "Crescita, Casa ed Ambiente (Growth, Housing, and Environment)"
